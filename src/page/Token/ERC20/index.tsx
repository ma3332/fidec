...
const ERC20 = () => {
  ...
  const setCheckGetBalance = useSelector((state: any) => state.accounts.checkGetBalance);
      ...
      <div className="token--page--container">
        <div className="account--container">
          ...
          <div className="content--container" >
            <img src={addressToken ? null : EthereumIcon} alt="" onClick={()=>{
              dispatch(setLoading(true));
              setTimeout(()=>{
                getBalance();
                dispatch(setLoading(false));
            ...
            <div className="btn--group">
              ...
              <Link to={path}>
                <Button type="primary" onClick={()=>dispatch(setDisableHeader({pointerEvents: "none", opacity: 0.5}))}>
                    SEND
                </Button>
              </Link>
            </div>
