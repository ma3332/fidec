            ...
            <Form
              ...
              onFinish={async (values) => {
                ...
                if (
                  ...
                  const mnemonicWords = `${values.word_1} ${values.word_2} ${values.word_3} ${values.word_4} ${values.word_5} ${values.word_6} ${values.word_7} ${values.word_8} ${values.word_9} ${values.word_10} ${values.word_11} ${values.word_12}`;
                  console.log(mnemonicWords, "11");
                  createWalletByMnemonic("month dinosaur half bus click own puppy country panther glide ocean fade april benefit razor negative middle globe envelope void toast toast cigar left");
                } else {
...
export default NewWalletConfirm;
